...
export const fetchTaskTC = createAsyncThunk('tasks/fetchTaskTC', (todolistId: string, thunkAPI)=>{
...
export const {removeTaskAC, addTaskAC, changeTaskStatusAC} = slice.actions
